...
class HybridDevice(Device):
    ...
    def __init__(self,
        ...
        hh_top_f = SlotType(name='+S', element_set=hh, anchor=(0.5, 0, 0.5), direction_matrix=MATRIX_IDENTITY)
        hh_top_b = SlotType(name='-S', element_set=hh, anchor=(0.5, 0, 0.5), direction_matrix=MATRIX_ROTX_180)
        he_top_f = SlotType(name='+S', element_set=he, anchor=(0.5, 0, 0.5), direction_matrix=MATRIX_IDENTITY)
        he_top_b = SlotType(name='-S', element_set=he, anchor=(0.5, 0, 0.5), direction_matrix=MATRIX_ROTX_180)
        ht_top_f = SlotType(name='+S', element_set=ht, anchor=(0.5, 0, 0.5), direction_matrix=MATRIX_IDENTITY)
        ht_top_b = SlotType(name='-S', element_set=ht, anchor=(0.5, 0, 0.5), direction_matrix=MATRIX_ROTX_180)
        pp_top   = SlotType(name='PP', element_set=pp, anchor=(0.5, 0, 0.5), direction_matrix=MATRIX_IDENTITY)
        pt_top   = SlotType(name='PT', element_set=pt, anchor=(0.5, 0, 0.5), direction_matrix=MATRIX_IDENTITY)

        hh_btm_f = SlotType(name='+S', element_set=hh, anchor=(0.5, 1, 0.5), direction_matrix=MATRIX_IDENTITY)
        hh_btm_b = SlotType(name='-S', element_set=hh, anchor=(0.5, 1, 0.5), direction_matrix=MATRIX_ROTX_180)
        he_btm_f = SlotType(name='+S', element_set=he, anchor=(0.5, 1, 0.5), direction_matrix=MATRIX_IDENTITY)
        he_btm_b = SlotType(name='-S', element_set=he, anchor=(0.5, 1, 0.5), direction_matrix=MATRIX_ROTX_180)
        ht_btm_f = SlotType(name='+S', element_set=ht, anchor=(0.5, 1, 0.5), direction_matrix=MATRIX_IDENTITY)
        ht_btm_b = SlotType(name='-S', element_set=ht, anchor=(0.5, 1, 0.5), direction_matrix=MATRIX_ROTX_180)
        pp_btm   = SlotType(name='PP', element_set=pp, anchor=(0.5, 1, 0.5), direction_matrix=MATRIX_IDENTITY)
        pt_btm   = SlotType(name='PT', element_set=pt, anchor=(0.5, 1, 0.5), direction_matrix=MATRIX_IDENTITY)
