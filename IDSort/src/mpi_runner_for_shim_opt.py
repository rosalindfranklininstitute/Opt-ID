...
if __name__ == "__main__":
    ...
    parser.add_option("--magnets", dest="magnets_filename", help="Set the path to the magnet description file", required=True, type="string")
    ...
    parser.add_option("-b", "--bfield", dest="bfield_filename", help="Set the path to the bfield table", required=True, type="string")
    parser.add_option("-g", "--genome", dest="genome_filename", help="Set the path to the genome", required=True, type="string")
